...
const Customers = () => {
    ...
    return (
        <div className="p-6 dark:bg-gray-900 min-h-screen">
            ...
            >
                {filterDue ? '✓ Showing Pending Due > 0' : 'Show Only Pending Due'}
            </button>
            </div>
                        ...
                        {loading ? (
                            ...
                            customers.map((customer) => (
                                <tr key={customer.id} className="hover:bg-gray-50 dark:hover:bg-gray-700 transition">
                                    ...
                                    <td className={`px-6 py-4 whitespace-nowrap text-right text-sm font-semibold ${customer.total_due && customer.total_due > 0
                                        ? 'text-red-600 dark:text-red-400'  // red if pending > 0
                                        : 'text-blue-600 dark:text-blue-400' // blue if zero pending
                                        }`}>
                                    ...
                                    <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                                        {viewingHistory.purchases.map((inv) => (
                                            <tr key={inv.id}>
                                                ...
                                                <td className="px-4 py-2 text-sm capitalize text-gray-900 dark:text-gray-200">{inv.payment_status}</td>
                                            </tr>
                                        ))}
                                    </tbody>
                                </table>
